...
const DeadCard = ({ lead }) => {
  ...
  const options = ["Convert to Warm", "Convert to Cold", "Delete Lead"];
  ...
  return (
    <article className="col-span-1 border rounded-md hover:shadow-md place-self-auto bg-white">
      ...
      <div className="flex flex-col px-4 items-center justify-center pb-6 relative -mt-3">
        ...
        <button className="bg-sidebar text-white py-1.5 md:py-2 w-fit px-10 text-center rounded-md text-xs sm:text-sm whitespace-nowrap font-semibold">
          Send Email
        </button>
      </div>
